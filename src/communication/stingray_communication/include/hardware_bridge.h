...
#include <stingray_communication_msgs/msg/hardware_info.h>
#include <stingray_communication_msgs/srv/set_horizontal_move.h>
#include <stingray_communication_msgs/srv/set_float64.h>
#include <stingray_communication_msgs/srv/set_int32.h>
#include <stingray_communication_msgs/srv/set_device_action.h>
#include <stingray_communication_msgs/srv/set_stabilization.h>
...
private:
    ...
    void horizontalMoveCallback(const std::shared_ptr<stingray_communication_msgs::srv::SetHorizontalMove::Request> &request, std::shared_ptr<stingray_communication_msgs::srv::SetHorizontalMove::Response> &request);
    ...
    void yawCallback(const std::shared_ptr<stingray_communication_msgs::srv::SetInt32::Request> request, std::shared_ptr<stingray_communication_msgs::srv::SetInt32::Response> response);
    ...
    rclcpp::Publisher<stingray_communication_msgs::msg::HardwareInfo> hardwareInfoPublisher;
