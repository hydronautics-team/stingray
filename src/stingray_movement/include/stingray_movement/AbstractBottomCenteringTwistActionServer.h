 ...
 * by march and lag.
 */
template <class TBottomCenteringTwistAction, class TBottomCenteringTwistActionGoal>
class AbstractBottomCenteringTwistActionServer : public AbstractTwistActionServer<TBottomCenteringTwistAction, TBottomCenteringTwistActionGoal> {
...
public:
    ...
    AbstractBottomCenteringTwistActionServer(std::shared_ptr<rclcpp::Node> _node, const std::string &actionName) : AbstractTwistActionServer<TBottomCenteringTwistAction, TBottomCenteringTwistActionGoal>(_node, actionName) {
    // ROS subscribers
        uvStateSub = _node->create_subscription<stingray_core_interfaces::msg::UVState>(
            ...
            std::bind(&AbstractBottomCenteringTwistActionServer::uvStateCallback, this, std::placeholders::_1));
    };
    ~AbstractBottomCenteringTwistActionServer() = default;
