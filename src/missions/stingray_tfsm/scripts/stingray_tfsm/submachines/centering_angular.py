    ...
    def setup_transitions(self):
        return [
            [self.machine.transition_start, [self.machine.state_init,
                                             'move_rotate' + self.name], 'condition_detected' + self.name],
            ...
            ['condition_s', 'condition_lefter' + self.name, 'move_rotate' + self.name],

            ['condition_f', 'condition_righter' + self.name, self.machine.state_end],
            ['condition_s', 'condition_righter' + self.name, 'move_rotate' + self.name],
        ]
